...
describe("generatePerceptualHash", () => {
    ...
    it('should call sharp methods in correct order', async () => {
        ...
        expect(resizeMock.mock.invocationCallOrder[0]).toBeLessThan(grayscaleMock.mock.invocationCallOrder[0]);
        expect(grayscaleMock.mock.invocationCallOrder[0]).toBeLessThan(rawMock.mock.invocationCallOrder[0]);
        expect(rawMock.mock.invocationCallOrder[0]).toBeLessThan(toBufferMock.mock.invocationCallOrder[0]);
    });
