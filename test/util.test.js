...
describe('moveDuplicates', () => {
    ...
    it('should move duplicate videos to duplicates directory', async () => {
        ...
        expect(fs.renameSync).toHaveBeenCalledWith(expect.any(String), expect.any(String));
    });
    ...
    it('should not move the first duplicate video in alphabetical order', async () => {
        ...
        await moveDuplicates();
        expect(fs.renameSync).not.toHaveBeenCalledWith(expect.stringContaining('dup1'), expect.any(String));
        expect(fs.renameSync).not.toHaveBeenCalledWith(expect.stringContaining('dup3'), expect.any(String));
    });
});
